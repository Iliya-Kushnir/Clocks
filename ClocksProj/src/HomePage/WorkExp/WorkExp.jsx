    ...
    return (
        <div className={styles.sectionWrapper}>
            <div className={styles.textSection}>
                ...
                <p className={styles.description}>Я – опытный часовщик с более чем 20-летним стажем. Работаю с любыми видами часов – от классических механических до современных кварцевых и автоматических моделей. Любая поломка – это вызов, который я с удовольствием принимаю. Отреставрирую, настрою и верну вашим часам идеальную точность и внешний вид. Гарантирую качественный ремонт и индивидуальный подход к каждому заказу.
                Ваши часы – в надежных руках!</p>
                <ReadMoreBtn
                type="button"
                onClick={() => {
                    console.log("Event listener works!")
                }}
                btnLabel="Читать больше!"
                />
